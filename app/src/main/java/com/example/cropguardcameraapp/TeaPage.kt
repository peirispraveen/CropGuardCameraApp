...
import com.example.cropguardcameraapp.ml.TeaDiagnosis
...
class TeaPage : AppCompatActivity() {
    ...
    private fun classifyImage(image: Bitmap) {
        val model = TeaDiagnosis.newInstance(applicationContext)
        ...
        val classes = arrayOf("brown_blight", "gray_blight", "healthy", "white_spot")
